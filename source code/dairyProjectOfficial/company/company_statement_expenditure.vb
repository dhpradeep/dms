...
Public Class company_statement_expenditure

    Public result As Double = 0.0
    Private Sub company_statement_expenditure_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ComboBox1.Select()
        TextBox2.Text = ""
    ...
    Private Sub FILL_ComboBox1()
        Try
            sql = "select particulars  FROM cashflow WHERE maintype='Expenses'"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            If CheckBox1.Checked = True Then
                ...
                sql5 = "INSERT INTO expenditurestatement(insertdate,statement,quantity,amount)VALUES('" & insertDate & "','" & ComboBox1.Text & "','" & TextBox1.Text & "','" & TextBox2.Text & "')"
            Else
                'sql command to insert with given date
                sql5 = "INSERT INTO expenditurestatement(insertdate,statement,quantity,amount)VALUES('" & DateTimePicker1.Text & "','" & ComboBox1.Text & "','" & TextBox1.Text & "','" & TextBox2.Text & "')"
            End If
            Try
                cmd = New OleDbCommand(sql5, connection1)
                cmd.ExecuteNonQuery()
                printmessage("Successfully insert new statement.", "Info", "Success")
                company_statement_expenditure_Load(e, e)
            Catch ex As Exception
                'MsgBox(ex.ToString())
            End Try
        End If
    ...
    Private Sub company_statement_expenditure_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
